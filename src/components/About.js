...
function About({aboutRef}) {
  return (
    ...
    transition={{ duration: 0.5 }} viewport={{ once:false }} ref={aboutRef}>
      ...
      <h2 className="about-header"> About Me </h2>
        ...
        <p>
          Check out my <a href="https://www.linkedin.com/in/christopher-garcia96/">LinkedIn</a>, <a href="https://github.com/cegarcia96">GitHub</a>, and <a href="https://drive.google.com/file/d/1ml4lJDN3IhzOYOqz2HMEYk3AuL4NbDuN/view?usp=sharing">resume</a> at the links below.
        </p>
